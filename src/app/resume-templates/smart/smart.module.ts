...
import { CertificatesBodyComponent } from 'src/app/resume-templates/smart/components/block-bodies/certificates-body/certificates-body.component';
import { EducationBodyComponent } from 'src/app/resume-templates/smart/components/block-bodies/education-body/education-body.component';
import { ExperienceBodyComponent } from 'src/app/resume-templates/smart/components/block-bodies/experience-body/experience-body.component';
import { SummaryBodyComponent } from 'src/app/resume-templates/smart/components/block-bodies/summary-body/summary-body.component';
import { UniversalSkillsBodyComponent } from 'src/app/resume-templates/smart/components/block-bodies/universal-skills-body/universal-skills-body.component';
import { IconsDropdownComponent } from 'src/app/resume-templates/smart/components/icons-dropdown/icons-dropdown.component';
import { InfoBlockBodyComponent } from 'src/app/resume-templates/smart/components/info-block-body/info-block-body.component';
